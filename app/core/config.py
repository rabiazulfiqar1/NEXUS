...
LLM_USE_MOCK = _to_bool(os.getenv("LLM_USE_MOCK"), default=False)
...
CREW_STORAGE_DIR = os.getenv("CREW_STORAGE_DIR")
GROQ_MODEL_LARGE=os.getenv("GROQ_MODEL_LARGE", "groq/llama-3.3-70b-versatile")
